...
# Iterating over a/ll the intents
...
def pred_class(text, model, vocab, labels):
...
def chatbot_response(msg, model, data, words, classes):
    ints = pred_class(msg, model, words, classes)
